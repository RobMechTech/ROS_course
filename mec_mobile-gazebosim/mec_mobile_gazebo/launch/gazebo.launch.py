...
def generate_launch_description():
    ...
    ekf_config_path = PathJoinSubstitution(
        [FindPackageShare("mec_mobile_gazebo"), "config", "ekf.yaml"]
    )

    # robot_base = os.getenv('mec_mobile_BASE')
    urdf_path = PathJoinSubstitution(
        [FindPackageShare("mec_mobile_description"), "urdf/robots","robot_3d.urdf.xacro"]
    )
    
    world_path = PathJoinSubstitution(
        [FindPackageShare("mec_mobile_gazebo"), "worlds", "turtlebot3_world.sdf"]
    )

    description_launch_path = PathJoinSubstitution(
        [FindPackageShare('mec_mobile_description'), 'launch', 'description.launch.py']
    )
